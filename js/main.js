...
let flag = false;
let permissions;
let promoted = ["tz1Yjryh3tpFHQG73dofJNatR21KUdRDu7mH","tz1brWSr91ZygR4gi5o19yo8QMff926y2B5e","tz1bdTgmF8pzBH9chtJptsjjrh5UfSXp1SQ4","tz1cXUERthGxHcDVAdKsFiFa4sSWbuGorghY","tz1exWwgsENRgBQKrjvo4xdhG18mRov1kjJa"];
...
async function fetchDelegateData() {
   ...
   try {
      ...
      data.forEach(delegate => {
         if (delegate.limitOfStakingOverBaking && delegate.limitOfStakingOverBaking > 0 && delegate.address!=="tz1aRoaRhSpRYvFdyvgWLL6TGyRoGF51wDjM" && delegate.address!=="tz1VQnqCCqX4K5sP3FNkVSNKTdCAMJDd3E1n") {
